...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return self.flagNames.count;
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    JWFlagCell *cell = [tableView dequeueReusableCellWithIdentifier:@"flagCell" forIndexPath:indexPath];
    
    //  cell.updateCell(image: UIImage(named: flagNames[indexPath.row]))
    UIImage *image = [UIImage imageNamed: self.flagNames[indexPath.row]];
